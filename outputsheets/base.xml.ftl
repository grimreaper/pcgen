...
<character>
	...
	<basics>
		...
		<deity>
			<name>${pc.deity!}</name>
			<alignment><@getarg pc.deity "alignment"/></alignment>		
			<description>${pc.deity.description!}</description>
			<domainlist><@getarg pc.deity "domainlist"/></domainlist>
	...
	<naturalattack>
		...
		<damage>${pcstring('ABILITYALL.Natural Attack.${NaturalAttack}.TYPE=NaturalAttack.ASPECT.NaturalAttackDamage')}</damage>
	...
	<eclipse_channeling kind="${pcstring('TEXT.UPPER.ABILITYALL.Special Ability.${eclipsecount}.ASPECT=ChannelingType.ASPECT.ChannelingKind')}" type="${pcstring('TEXT.UPPER.ABILITYALL.Special Ability.${eclipsecount}.ASPECT=ChannelingType.ASPECT.ChannelingType')}">
		...
		<intensity>1d20${pcstring('ABILITYALL.Special Ability.${eclipsecount}.ASPECT=ChannelingType.ASPECT.ChannelingIntensity.INTVAL.SIGN')}</intensity>
		<channel_intensity>${pcstring('ABILITYALL.Special Ability.${eclipsecount}.ASPECT=ChannelingType.ASPECT.ChannelingIntensity.INTVAL')}</channel_intensity>
		...
		<damage_bonus>${pcstring('ABILITYALL.Special Ability.${eclipsecount}.ASPECT=ChannelingType.ASPECT.ChannelingMagnitudeBonus')}</damage_bonus>
		<uses_per_day>${pcstring('ABILITYALL.Special Ability.${eclipsecount}.ASPECT=ChannelingType.ASPECT.ChannelingUses.INTVAL')}</uses_per_day>
		<range>${pcstring('ABILITYALL.Special Ability.${eclipsecount}.ASPECT=ChannelingType.ASPECT.ChannelingRange.INTVAL')}</range>
...
<!-- Pathfinder 
	...
	<@abilityBlock category="Salient Divine Ability" nature="ALL" hidden=false typeName="" nodeName="salient_divine_ability" />
	</salient_divine_abilities>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<occupations>
	<@abilityBlock category="Starting Occupation" nature="ALL" hidden=false typeName="" nodeName="occupation" />
	</occupations>
	...
	<!-- Eclipse Section -->
	  ...
	  ====================================-->
	<charcreations>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="CharCreation" nodeName="charcreation" />
	</charcreations>
		<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<disadvantages>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="Disadvantage" nodeName="disadvantage" />
	</disadvantages>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<eclipse_abilities>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="EclipseAbilityOutput" nodeName="eclipse_ability" />
	</eclipse_abilities>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<spellcasteroutputs>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="SpellCasterOutput" nodeName="spellcasteroutput" />
	</spellcasteroutputs>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<martial_arts>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="MartialArtsOutput" nodeName="martial_art" />
	</martial_arts>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<mystic_artists>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="MysticArtistOutput" nodeName="mystic_artist" />
	</mystic_artists>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<witchcrafts>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="WitchcraftOutput" nodeName="witchcraft" />
	</witchcrafts>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<path_dragons>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="PathoftheDragon" nodeName="path_dragon" />
	</path_dragons>
		<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<dominions>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="Dominion" nodeName="dominion" />
	</dominions>
	<!--
	  ====================================
	  ====================================
	...
	<@loop from=0 to=pcvar('countdistinct("ABILITIES","CATEGORY=Special Ability","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY","TYPE=AtWill")-1') ; atWill , atWill_has_next>
		<powers_atwill>
			...
			<count>${pcstring('ABILITYALL.Special Ability.VISIBLE.${atWill}.TYPE=AtWill.ASSOCIATEDCOUNT')}</count>
			<auto>F</auto>
			<hidden>F</hidden>
			<virtual>F</virtual>
			<category>Special Ability</category>
	...
	<@loop from=0 to=pcvar('countdistinct("ABILITIES","CATEGORY=Power","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY","TYPE=At-Will")-1') ; atWill , atWill_has_next>
		<powers_atwill>
			...
			<count>${pcstring('ABILITYALL.Power.VISIBLE.${atWill}.TYPE=At-Will.ASSOCIATEDCOUNT')}</count>
			<auto>F</auto>
			<hidden>F</hidden>
			<virtual>F</virtual>
			<category>Power</category>
	...
	<@loop from=0 to=pcvar('countdistinct("ABILITIES","CATEGORY=Special Ability","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY","TYPE=Encounter")-1') ; encounter , encounter_has_next>
		<powers_encounter>
			...
			<count>${pcstring('ABILITYALL.Special Ability.VISIBLE.${encounter}.TYPE=Encounter.ASSOCIATEDCOUNT')}</count>
			<auto>F</auto>
			<hidden>F</hidden>
			<virtual>F</virtual>
			<category>Special Ability</category>
	...
	<@loop from=0 to=pcvar('countdistinct("ABILITIES","CATEGORY=Special Ability","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY","TYPE=Daily")-1') ; daily , daily_has_next>
		<powers_daily>
			...
			<count>${pcstring('ABILITYALL.Special Ability.VISIBLE.${daily}.TYPE=Daily.ASSOCIATEDCOUNT')}</count>
			<auto>F</auto>
			<hidden>F</hidden>
			<virtual>F</virtual>
			<category>Special Ability</category>
	...
	<@loop from=0 to=pcvar('countdistinct("ABILITIES","CATEGORY=Special Ability","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY","TYPE=Utility")-1') ; utility , utility_has_next>
		<powers_utility>
			...
			<count>${pcstring('ABILITYALL.Special Ability.VISIBLE.${utility}.TYPE=Utility.ASSOCIATEDCOUNT')}</count>
			<auto>F</auto>
			<hidden>F</hidden>
			<virtual>F</virtual>
			<category>Special Ability</category>
	...
	<!--
	  ...
	  ====================================-->
	<demon_cants>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="DemonCant" nodeName="demon_cant" />
	</demon_cants>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<mage_gnosises>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="MageGnosis" nodeName="mage_gnosis" />
	</mage_gnosises>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<vampire_disciplines>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="VampireDiscipline" nodeName="vampire_discipline" />
	</vampire_disciplines>
	<!--
	  ====================================
	  ====================================
	  ...
	  ====================================-->
	<werewolf_rites>
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="WerewolfRite" nodeName="werewolf_rite" />
	</werewolf_rites>
