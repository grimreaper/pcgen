 ...
 */
public class EquipmodToken extends AbstractTokenWithSeparator<KitGear> implements
		CDOMPrimaryToken<KitGear>
{
		...
		KitGear kitGear, String value)
	{
		...
		{
			String aEqModName = pipeTok.nextToken();
			...
			StringTokenizer dotTok =
					new StringTokenizer(aEqModName, Constants.DOT);

			// The type of EqMod, eg: ABILITYPLUS
			final String eqModKey = dotTok.nextToken();
			...
			{
				String assocTok = dotTok.nextToken();
