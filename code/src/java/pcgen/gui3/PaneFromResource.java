...
/**
 * Loads FXML content as a generic Pane
 *
 * @param <T> The class of the controller
 */
public final class PaneFromResource<T> extends Pane implements Controllable<T>
{
	 ...
	 */
	public PaneFromResource(Class<? extends T> klass, String resourceName)
	{
