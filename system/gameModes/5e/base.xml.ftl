...
<character>
	...
	<skills>
	<@loop from=0 to=pcvar('countdistinct("ABILITIES","CATEGORY=SkillExport","VISIBILITY=DEFAULT[or]VISIBILITY=OUTPUT_ONLY","TYPE=SkillExport")-1') ; skillExport , skillExport_has_next>
		<skill>
			<name>${pcstring('ABILITYALL.SkillExport.VISIBLE.${skillExport}.TYPE=SkillExport')}</name>
			<skill_proficiency>${pcstring('ABILITYALL.SkillExport.VISIBLE.${skillExport}.TYPE=SkillExport.ASPECT.Skill Proficiency')}</skill_proficiency>
			<ability>${pcstring('ABILITYALL.SkillExport.VISIBLE.${skillExport}.TYPE=SkillExport.ASPECT.KEYSTAT')}</ability>
			<skill_mod>${pcstring('ABILITYALL.SkillExport.VISIBLE.${skillExport}.TYPE=SkillExport.ASPECT.Total')}</skill_mod>
			<ability_mod>${pcstring('ABILITYALL.SkillExport.VISIBLE.${skillExport}.TYPE=SkillExport.ASPECT.AbilityMod')}</ability_mod>
			<ranks>${pcstring('ABILITYALL.SkillExport.VISIBLE.${skillExport}.TYPE=SkillExport.ASPECT.ProfBonus')}</ranks>
			<misc_mod>${pcstring('ABILITYALL.SkillExport.VISIBLE.${skillExport}.TYPE=SkillExport.ASPECT.MiscBonus')}</misc_mod>	<#-- Not currently used -->
		</skill>
	</@loop>
	<!-- Skills -->
	</skills>
